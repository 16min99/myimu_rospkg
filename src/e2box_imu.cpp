...
void e2box_imu::Initialize(void)
{
...
void e2box_imu::ExtractData(unsigned char byteCurrent)
{
...
bool e2box_imu::HandlingDataIMU(){
    if(GetStatusHeaderDetect() == false){
        InterpretGeneral();
...
void e2box_imu::InterpretGeneral(void)
{
    char cBranch;
...
BOOL e2box_imu::CalcCheckSum(void)
{
...
DWORD e2box_imu::CheckBYTEXOR(BYTE byteCompared1, BYTE byteCompared2)
{
    BYTE byteMask = 0x80;
    BYTE byteResult = 0;
